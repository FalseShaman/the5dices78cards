<?php
    ...
    {
        $map .= '<div class="col-sm-2" id="cardPlace'.$placeNumber.'" style="border: solid 1px; border-radius: 7px; height: 250px;">
    ...
    $minorArcanaSelector = '';
    for ($i=0;$i<14;$i++) {
        $minorArcanaSelector .= '<button type="button" class="btn btn-dark arcanaSelectButton" id="'.$i.'" style="margin: 10px;">'.$translateList['minorArcana'][$i].'</button>';
    }
